...
* [SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,109 | 🐛 126 | 🌐 Python | 📅 2026-08-26 - Open-source deep learning framework for Spiking Neural Network (SNN) based on PyTorch.
...
* [Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,566 | 🐛 57 | 🌐 C# | 📅 2024-11-26 - list with robotics simulation tools in Unity.
...
* [BrainPy](https://github.com/brainpy/BrainPy) ⭐ 704 | 🐛 4 | 🌐 Python | 📅 2026-08-13 - Framework for computational neuroscience and brain-inspired computation based on the Just-In-Time (JIT) compilation (built on top of JAX, Numba, and other JIT compilers). It provides an integrative ecosystem for brain dynamics programming, including brain dynamics building, simulation, training, analysis, etc.
...
* [Event-based Vision Resources](https://github.com/uzh-rpg/event-based_vision_resources#neuromorphic-systems) ⭐ 3,634 | 🐛 1 | 📅 2026-08-14 - Big articles list.

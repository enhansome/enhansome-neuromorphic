...
* [SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,111 | 🐛 127 | 🌐 Python | 📅 2026-08-27 - Open-source deep learning framework for Spiking Neural Network (SNN) based on PyTorch.
...
* [Unity Robotics Hub](https://github.com/Unity-Technologies/Unity-Robotics-Hub) ⭐ 2,566 | 🐛 56 | 🌐 C# | 📅 2024-11-26 - list with robotics simulation tools in Unity.
...
* [Event-based Vision Resources](https://github.com/uzh-rpg/event-based_vision_resources#neuromorphic-systems) ⭐ 3,634 | 🐛 2 | 📅 2026-08-14 - Big articles list.

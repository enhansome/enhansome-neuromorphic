...
* [SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,124 | 🐛 125 | 🌐 Python | 📅 2026-09-07 - Open-source deep learning framework for Spiking Neural Network (SNN) based on PyTorch.
* [BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,698 | 🐛 8 | 🌐 Python | 📅 2026-09-07 - Python package used for simulating spiking neural networks (SNNs) on CPUs or GPUs using PyTorch Tensor functionality. BindsNET is a spiking neural network simulation library geared towards the development of biologically inspired algorithms for machine learning.
...
* [Event-based Vision Resources](https://github.com/uzh-rpg/event-based_vision_resources#neuromorphic-systems) ⭐ 3,640 | 🐛 3 | 📅 2026-08-14 - Big articles list.

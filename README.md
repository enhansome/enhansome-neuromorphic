...
* [SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,137 | 🐛 125 | 🌐 Python | 📅 2026-09-19 - Open-source deep learning framework for Spiking Neural Network (SNN) based on PyTorch.
...
* [Event-based Vision Resources](https://github.com/uzh-rpg/event-based_vision_resources#neuromorphic-systems) ⭐ 3,645 | 🐛 1 | 📅 2026-09-17 - Big articles list.

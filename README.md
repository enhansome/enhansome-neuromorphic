...
* [SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,108 | 🐛 127 | 🌐 Python | 📅 2026-08-25 - Open-source deep learning framework for Spiking Neural Network (SNN) based on PyTorch.
...
* [Event-based Vision Resources](https://github.com/uzh-rpg/event-based_vision_resources#neuromorphic-systems) ⭐ 3,633 | 🐛 1 | 📅 2026-08-14 - Big articles list.
